...
:class:`PyAnsysBaseMCP`
=======================


.. py:class:: src.ansys.common.mcp.server.PyAnsysBaseMCP(python_executable: Optional[str] = None, working_directory: Optional[str] = None, *args, **kwargs)
...
.. py:currentmodule:: PyAnsysBaseMCP
...
.. code-block:: python
    ...
    from src.ansys.common.mcp.server import PyAnsysBaseMCP
...
.. py:method:: product_lifespan(server: fastmcp.FastMCP) -> AsyncIterator[ansys.common.mcp.context.PyAnsysBaseAppContext]
   :async:
   ...
   :Yields:
       ...
       :obj:`AsyncIterator`\[:obj:`PyAnsysBaseAppContext`]
