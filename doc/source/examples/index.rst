...
.. grid:: 2
    ...
    .. grid-item-card:: Complete example: PyExample-MCP
       :link: ref_pyexample_mcp
       :link-type: ref
    ...
    .. grid-item-card:: Real-world example: PyMAPDL-MCP
       ...
       A production-ready MCP server implementation for PyMAPDL. Explore advanced
       patterns and real-world best practices in action.
